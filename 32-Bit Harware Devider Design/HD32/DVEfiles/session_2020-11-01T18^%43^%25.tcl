...
# DVE full session
# Saved on Sun Nov 1 18:43:25 2020
# Designs open: 1
...
#<Session mode="Full" path="/mnt/hgfs/SF/HD32/DVEfiles/session.tcl" type="Coverage">
...
# Create and position top-level windows :CovTopLevel.1
...
gui_show_window -window ${CovTopLevel.1} -show_state normal -rect {{35 118} {749 822}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 388} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 0} {child_covhier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 714} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${CoverageTable.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {Layout_CoverageTable_covtblFGroupsList_names Group, ,  ,   ,Score,} {Layout_CoverageTable_covtblFGroupsList_widths 220,25,0,0,125,} {Layout_CoverageTable_covtblFGroupsList_orders 3,0,1,2,4,} {Layout_CoverageTable_covtblInstancesList_names Name, ,  ,   ,Score,Line,Toggle,FSM,Condition,Branch,} {Layout_CoverageTable_covtblInstancesList_widths 220,25,0,0,125,125,140,125,123,125,} {Layout_CoverageTable_covtblInstancesList_orders 3,0,1,2,4,5,6,7,8,9,} {Layout_CoverageTable_covtblModulesList_names Name, ,  ,   ,Score,Line,Toggle,FSM,Condition,Branch,} {Layout_CoverageTable_covtblModulesList_widths 220,25,0,0,125,125,125,125,125,125,} {Layout_CoverageTable_covtblModulesList_orders 3,0,1,2,4,5,6,7,8,9,}}

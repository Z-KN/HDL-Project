...
# DVE full session
# Saved on Sun Nov 1 18:49:25 2020
# Designs open: 1
...
gui_show_window -window ${CovTopLevel.1} -show_state normal -rect {{37 119} {750 822}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 387} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 0} {child_covhier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 713} {height 179} {dock_state bottom} {dock_on_new_line true}}

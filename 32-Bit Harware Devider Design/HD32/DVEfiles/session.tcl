...
# DVE full session
# Saved on Mon Nov 2 01:41:16 2020
# Designs open: 1
...
gui_show_window -window ${CovTopLevel.1} -show_state normal -rect {{39 120} {751 822}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 386} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 0} {child_covhier_col2 1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 712} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${CoverageTable.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {Layout_CoverageTable_covtblFGroupsList_names Group, ,  ,   ,Score,} {Layout_CoverageTable_covtblFGroupsList_widths 220,25,0,0,125,} {Layout_CoverageTable_covtblFGroupsList_orders 3,0,1,2,4,} {Layout_CoverageTable_covtblInstancesList_names Name, ,  ,   ,Score,Line,FSM,Condition,Branch,} {Layout_CoverageTable_covtblInstancesList_widths 220,25,0,0,125,125,125,123,125,} {Layout_CoverageTable_covtblInstancesList_orders 3,0,1,2,4,5,6,7,8,} {Layout_CoverageTable_covtblModulesList_names Name, ,  ,   ,Score,Line,FSM,Condition,Branch,} {Layout_CoverageTable_covtblModulesList_widths 220,25,0,0,125,125,125,125,125,} {Layout_CoverageTable_covtblModulesList_orders 3,0,1,2,4,5,6,7,8,}}
...
catch {gui_list_expand -id ${CoverageTable.1} testbench}

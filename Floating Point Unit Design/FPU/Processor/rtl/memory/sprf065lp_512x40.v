...
//*        Library Name     : ts5n65lphslvta512x40m4s (user specify : sprf065lp_512x40)
//*        Library Version  : 200b
//*        Generated Time   : 2011/06/14, 15:43:56
//*******************************************************************************
`resetall
`celldefine
`timescale 1ns/1ps
...
parameter N  = 40;                                      // word width
parameter W  = 512;                                    // word depth
parameter M  = 9;                                      // address width
...
specparam tckl = 0.371;
specparam tckh = 0.371;
specparam tcyc = 0.927;

specparam tas = 0.135;
specparam tah = 0.107;
specparam tds = 0.117;
specparam tdh = 0.157;
specparam tcebs = 0.255;
specparam tcebh = 0.040;
specparam twebs = 0.095;
specparam twebh = 0.062;
specparam tbwebs = 0.080;
specparam tbwebh = 0.157;
...
// CLK-2-Q
specparam tckq = 0.789;
specparam tckqh = 0.617;

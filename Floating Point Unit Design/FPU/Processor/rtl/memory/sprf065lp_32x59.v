...
//*        Library Name     : ts5n65lphslvta32x59m4s (user specify : sprf065lp_32x59)
//*        Library Version  : 200b
//*        Generated Time   : 2011/07/12, 14:48:47
//*******************************************************************************
`resetall
`celldefine
`timescale 1ns/1ps
...
parameter N  = 59;                                      // word width
parameter W  = 32;                                    // word depth
parameter M  = 5;                                      // address width
...
specparam tckl = 0.362;
specparam tckh = 0.362;
specparam tcyc = 0.904;

specparam tas = 0.089;
specparam tah = 0.107;
specparam tds = 0.104;
specparam tdh = 0.175;
specparam tcebs = 0.193;
specparam tcebh = 0.040;
specparam twebs = 0.095;
specparam twebh = 0.062;
specparam tbwebs = 0.072;
specparam tbwebh = 0.175;
...
// CLK-2-Q
specparam tckq = 0.652;
specparam tckqh = 0.593;

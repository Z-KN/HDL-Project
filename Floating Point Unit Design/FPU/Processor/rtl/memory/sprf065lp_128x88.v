...
//*        Library Name     : ts5n65lphslvta128x88m2s (user specify : sprf065lp_128x88)
//*        Library Version  : 200b
//*        Generated Time   : 2011/07/20, 13:58:25
//*******************************************************************************
`resetall
`celldefine
`timescale 1ns/1ps
...
parameter N  = 88;                                      // word width
parameter W  = 128;                                    // word depth
parameter M  = 7;                                      // address width
...
buf iD84 (b_D[84], D[84]);
buf iD85 (b_D[85], D[85]);
buf iD86 (b_D[86], D[86]);
buf iD87 (b_D[87], D[87]);
...
buf iBWEB84 (b_BWEB[84], BWEB[84]);
buf iBWEB85 (b_BWEB[85], BWEB[85]);
buf iBWEB86 (b_BWEB[86], BWEB[86]);
buf iBWEB87 (b_BWEB[87], BWEB[87]);
...
nmos iQ84 (Q[84], Q_n[84], 1'b1);
nmos iQ85 (Q[85], Q_n[85], 1'b1);
nmos iQ86 (Q[86], Q_n[86], 1'b1);
nmos iQ87 (Q[87], Q_n[87], 1'b1);
// Test Mode
buf (TSEL_i[0], TSEL[0]);
buf (TSEL_i[1], TSEL[1]);
...
specparam tbwebs = 0.071;
specparam tbwebh = 0.194;
...
// CLK-2-Q
specparam tckq = 0.710;
specparam tckqh = 0.581;
  ...
  $setuphold(posedge CLK &&& WE, posedge D[84], tds, tdh, notifier_D);
  $setuphold(posedge CLK &&& WE, negedge D[84], tds, tdh, notifier_D);
  $setuphold(posedge CLK &&& WE, posedge D[85], tds, tdh, notifier_D);
  $setuphold(posedge CLK &&& WE, negedge D[85], tds, tdh, notifier_D);
  $setuphold(posedge CLK &&& WE, posedge D[86], tds, tdh, notifier_D);
  $setuphold(posedge CLK &&& WE, negedge D[86], tds, tdh, notifier_D);
  $setuphold(posedge CLK &&& WE, posedge D[87], tds, tdh, notifier_D);
  $setuphold(posedge CLK &&& WE, negedge D[87], tds, tdh, notifier_D);
  ...
  $setuphold(posedge CLK &&& WE, posedge BWEB[84], tbwebs, tbwebh, notifier_D);
  $setuphold(posedge CLK &&& WE, negedge BWEB[84], tbwebs, tbwebh, notifier_D);
  $setuphold(posedge CLK &&& WE, posedge BWEB[85], tbwebs, tbwebh, notifier_D);
  $setuphold(posedge CLK &&& WE, negedge BWEB[85], tbwebs, tbwebh, notifier_D);
  $setuphold(posedge CLK &&& WE, posedge BWEB[86], tbwebs, tbwebh, notifier_D);
  $setuphold(posedge CLK &&& WE, negedge BWEB[86], tbwebs, tbwebh, notifier_D);
  $setuphold(posedge CLK &&& WE, posedge BWEB[87], tbwebs, tbwebh, notifier_D);
  $setuphold(posedge CLK &&& WE, negedge BWEB[87], tbwebs, tbwebh, notifier_D);
  ...
  (posedge CLK => (Q[84] +: 1'bx)) = (tckq,tckq,tckqh,tckq,tckqh,tckq);
  (posedge CLK => (Q[85] +: 1'bx)) = (tckq,tckq,tckqh,tckq,tckqh,tckq);
  (posedge CLK => (Q[86] +: 1'bx)) = (tckq,tckq,tckqh,tckq,tckqh,tckq);
  (posedge CLK => (Q[87] +: 1'bx)) = (tckq,tckq,tckqh,tckq,tckqh,tckq);
